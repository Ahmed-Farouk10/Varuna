  ...
  if (isConnecting) {
    return (
      <div className="w-full">
        <h2 className="text-xl font-bold mb-4 text-gray-900 font-cool">💬 Chat with Irrigation Assistant</h2>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col" style={{ height: '600px' }}>
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          <button
            ...
            type="button"
            className="w-full mb-3 px-4 py-2.5 rounded-lg bg-gradient-to-r from-[#7AD7B1] to-[#4CAB5B] text-gray-900 font-bold text-sm shadow-md hover:shadow-lg transform hover:scale-105 transition-all hover:from-[#6BC7A1] hover:to-[#3D9B4D]"
          >
          ...
          >
            <input
              ...
              className="flex-1 p-2.5 rounded-lg border-2 border-purple-300 focus:outline-none focus:ring-2 focus:ring-[#A49FFF] focus:border-[#A49FFF] text-sm bg-white text-gray-900"
            />
            <button
              type="submit"
              className="bg-[#A49FFF] text-gray-900 font-bold px-4 py-2.5 rounded-lg hover:bg-[#B8E6D8] hover:text-gray-900 transition-all flex items-center gap-2 text-sm shadow-md hover:shadow-lg"
            >
              <span>Send</span>
